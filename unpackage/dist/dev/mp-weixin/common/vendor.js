...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"bleToolDemo","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*****************************************!*\
  !*** D:/project/bleToolDemo/pages.json ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!***********************************************!*\
  !*** D:/project/bleToolDemo/utils/bleTool.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var XpP323b = {
  oneWriteData: 50 };var

BleTool = /*#__PURE__*/function () {
  function BleTool(e) {_classCallCheck(this, BleTool);
    var that = this;
    //记录自身，防止某些函数this指向问题
    this.self = this;
    //全局app
  ...
  //初始化蓝牙
  _createClass(BleTool, [{ key: "init", value: function init() {
      var that = this;
      console.log("初始化蓝牙");
      //初始化蓝牙设备
      if (!this.initState) {
      ...
      var bleToolList = uni.getStorageSync('bleToolList');
    ...
    //获取蓝牙状态
  }, { key: "getBleState", value: function getBleState() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      this.silence = false;
    ...
    //搜索蓝牙
  }, { key: "search", value: function search() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      this.silence = false;
      //开始进行搜索
      if (!this.available) {
        that.getBleState(function (callbacks) {
          if (!callbacks) {
            callback(false);
            return false;
          }
      ...
      var platform = that.systemInfo.platform;
      if (platform == 'ios') {
        that.startSearchDevice(callback);
      } else if (platform == 'android') {
        var system = that.systemInfo.system;
    ...
    //搜索
  }, { key: "startSearchDevice", value: function startSearchDevice() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      ...
      that.deviceTimer = setInterval(function () {
    ...
    //搜索监听
  }, { key: "wechatGetDevice", value: function wechatGetDevice() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
    ...
    //搜索触发开始
  }, { key: "startBluetoothDevices", value: function startBluetoothDevices() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      if (this.available) {
        if (!this.searchState) {
          console.log("搜索触发开始");
    ...
    //停止搜索
  }, { key: "stopSearchDevice", value: function stopSearchDevice() {
      console.log("停止搜索开始");
      uni.hideLoading();
      var that = this;
    ...
    //监听蓝牙适配器状态
  }, { key: "listenAdapterStateChange", value: function listenAdapterStateChange() {
      var that = this;
    ...
    //监听蓝牙连接状态
  }, { key: "listenConnection", value: function listenConnection() {
      var that = this;
    ...
    //检查蓝牙适配器
  }, { key: "checkAvailable", value: function checkAvailable(opt, available) {
      var that = this;
    ...
    //打开蓝牙
  }, { key: "openBLEAdapter", value: function openBLEAdapter() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      console.log("初始化打开蓝牙");
      this.initState = true;
    ...
    // 连接设备
  }, { key: "connectDevice", value: function connectDevice(item) {var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var that = this;
    ...
    //连接进行
  }, { key: "connectDeviceStart", value: function connectDeviceStart(item, msg) {var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {};
      var that = this;
      if (item.deviceId) {
        uni.showToast({
          title: '设备ID不可空',
      ...
      uni.createBLEConnection({
        ...
        success: function success(res) {
          ...
          var setStorageState = true;
          for (var i = 0; i < that.storageDeviceList.length; i++) {
    ...
    //搜索服务
  }, { key: "searchService", value: function searchService() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      console.log("搜索服务");
      var that = this;
      uni.showLoading({
        title: "数据处理中" });
    ...
    /**
       * 特征值获取
       */ }, { key: "characteristic", value: function characteristic()
    {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      ...
      uni.getBLEDeviceCharacteristics({
        ...
        success: function success(res) {
          ...
          for (var i = 0; i < res.characteristics.length; i++) {//写入的特征值
            var ct = res.characteristics[i];
    ...
    //读取设备状态
  }, { key: "readDeviceState", value: function readDeviceState() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      console.log(读取设备状态);
    ...
    //打开订阅
  }, { key: "openNotify", value: function openNotify() {
      var that = this;
    ...
    // 监听特征值变化
  }, { key: "listenNotifyValueChange", value: function listenNotifyValueChange() {
      var that = this;
      console.log("监听特征变化");
      uni.onBLECharacteristicValueChange(function (res) {
        ...
        var value = res.value;
        console.log(value);
        var value2 = that.uint8Array2Str(value);
        console.log("returnstr", value2);
        var dataView = new DataView(that.string2Buffer(value2));
      });
    }
    //断开蓝牙连接
  }, { key: "cancelBleConnect", value: function cancelBleConnect() {var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
      var that = this;
      console.log("断开连接");
      if (that.connectState) {
    ...
    //多次写入
  }, { key: "writeCharacteristicList", value: function writeCharacteristicList(buff) {var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var that = this;
    ...
    //多次写入执行
  }, { key: "writeCharacteristicSend", value: function writeCharacteristicSend(buff) {var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var that = this;
      console.log("多次写入执行");
    ...
    //写入数据
  }, { key: "writeCharacteristicValue", value: function writeCharacteristicValue(buff) {var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
    ...
    //16进制字符串转整形数组
  }, { key: "str2Bytes", value: function str2Bytes(str) {
      var len = str.length;
      if (len % 2 != 0) {
        return null;
      }
    ...
    //整形数组转buffer
  }, { key: "array2Buffer", value: function array2Buffer(arr) {
    ...
    //整形数组转buffer
  }, { key: "string2Buffer", value: function string2Buffer(str) {
      var arr = this.str2Bytes(str);
      return this.array2Buffer(arr);
    }
    //ArrayBuffer转十六进制字符串
  }, { key: "uint8Array2Str", value: function uint8Array2Str(buffer) {
      var str = "";
      var dataView = new DataView(buffer);
    ...
    //十六进制倒序,非十六进制返回空
  }, { key: "reverse16", value: function reverse16(str16) {
      ...
      return "";
    } }]);return BleTool;}();exports.default = BleTool;
...
/* 22 */
/*!************************************************!*\
  !*** D:/project/bleToolDemo/utils/encoding.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 23 */
/*!********************************************************!*\
  !*** D:/project/bleToolDemo/utils/encoding-indexes.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
